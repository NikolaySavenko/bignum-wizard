            ...
            get
            {
                return new[]
                {
                    ...
                    new object[] {
                        ...
                        new Polynomial(new BigNum("4"), new List<BigFraction>() { new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(new BigNum("5")) })
                    },
                    new object[] {
                        new BigNum("2"),
                        ...
                        new BigNum("3"),
                        new List<BigFraction>() { new BigFraction(BigNum.One), new BigFraction(new BigNum("2")), new BigFraction(new BigNum("3")), new BigFraction(new BigNum("4")) },
                        new Polynomial(new BigNum("3"), new List<BigFraction>() { new BigFraction(BigNum.Zero), new BigFraction(BigNum.One), new BigFraction(new BigNum("2")), new BigFraction(new BigNum("3")) })
                    },
                    new object[] {
                        new BigNum("3"),
                        new List<BigFraction>() { new BigFraction(BigNum.One), new BigFraction(new BigNum("2")), new BigFraction(new BigNum("3")), new BigFraction(new BigNum("4")) },
                        new BigNum("3"),
                        new List<BigFraction>() { new BigFraction(BigNum.One), new BigFraction(new BigNum("2")), new BigFraction(new BigNum("3")), new BigFraction(new BigNum("4")) },
                        new Polynomial(new BigNum("3"), new List<BigFraction>() { new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero) } )
                    },
                    new object[] {
                        new BigNum("2"),
                        ...
                        new Polynomial(new BigNum("2"), new List<BigFraction>() { new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(BigNum.One)} )
                    },
                    new object[] {
                        new BigNum("6"),
                        ...
                        new Polynomial(new BigNum("6"), new List<BigFraction>() { new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(BigNum.One, new BigNum("288")), new BigFraction(new BigNum("7"), new BigNum("9")), new BigFraction(new BigNum("12"), new BigNum("11")), new BigFraction(new BigNum("-16"), new BigNum("33")), new BigFraction(new BigNum("101"), new BigNum("99")) } )
                    },
                    new object[] {
                        new BigNum("3"),
                        ...
                        new Polynomial(new BigNum("3"), new List<BigFraction>() { new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(new BigNum("67507334"), new BigNum("3")), new BigFraction(new BigNum("950926"), new BigNum("9")) } )
                    },
                    new object[] {
                        new BigNum("2"),
                        ...
                        new Polynomial(new BigNum("3"), new List<BigFraction>() { new BigFraction(BigNum.Zero), new BigFraction(BigNum.One), new BigFraction(new BigNum("24346789")), new BigFraction(new BigNum("6688888888881")) })
                    },
                    new object[] {
                        new BigNum("3"),
                        ...
                        new Polynomial(new BigNum("3"), new List<BigFraction>() { new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(new BigNum("-122222222")), new BigFraction(new BigNum("122222222")) } )
                    },
                    new object[] {
                        new BigNum("3"),
                        ...
                        new Polynomial(new BigNum("3"), new List<BigFraction>() { new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(new BigNum("1622"), new BigNum("363")), new BigFraction(new BigNum("179"), new BigNum("33")) } )
                    },
                };
            }
        }
