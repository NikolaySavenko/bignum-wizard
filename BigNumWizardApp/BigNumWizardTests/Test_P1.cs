            ...
            get
            {
                return new[]
                {
                    ...
                    new object[] {
                       ...
                       new Polynomial(new BigNum("8"),new List<BigFraction>(){new BigFraction(new BigNum("-32525"), new BigNum("23423")),new BigFraction(new BigNum("12312424"), new BigNum("534523")),new BigFraction(BigNum.Zero),new BigFraction(BigNum.Zero),new BigFraction(new BigNum("25632394449"), new BigNum("121780952")),new BigFraction(new BigNum("401548384215"), new BigNum("179263706")),new BigFraction(new BigNum("250711085109"), new BigNum("8184182495")),new BigFraction(new BigNum("323531877744305"), new BigNum("2434815596214")),new BigFraction(new BigNum("-2836111902"), new BigNum("373269887")),})
                    },
                    new object[] {
                        new BigNum("3"),
