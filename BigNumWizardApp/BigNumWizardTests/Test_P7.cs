        ...
        public static IEnumerable<object[]> Data
        {
            get
            {
                return new[]
                {
                    ...
                    new object[] {new BigNum("5"), new List<BigFraction> {new BigFraction(new BigNum("250324657381418613827633319399"), new BigNum("256")), new BigFraction(new BigNum("-4118978453276069918436511891929"), new BigNum("64")), new BigFraction(new BigNum("3117679823750395463125978614333"), new BigNum("32")), new BigFraction(new BigNum("113783935173372097194378781545"), new BigNum("1024")), new BigFraction(new BigNum("4118978453276069918436511891929"), new BigNum("512")), new BigFraction(new BigNum("-6986333619645046767734857186863"), new BigNum("2")) }, "22756787034674419438875756309", "1024"},
                    ...
                    new object[] {new BigNum("2"), new List<BigFraction> {new BigFraction(new BigNum("3"), new BigNum("5")), new BigFraction(new BigNum("7"), new BigNum("11")), new BigFraction(new BigNum("22"), new BigNum("14"))}, "1", "770" },
                    new object[] {new BigNum("2"), new List<BigFraction> {new BigFraction(new BigNum("1771338"), new BigNum("3453")), new BigFraction(new BigNum("2402706"), new BigNum("234")), new BigFraction(new BigNum("1175046"), new BigNum("2345"))}, "17538", "631588230" },
                    new object[] {new BigNum("3"), new List<BigFraction> {new BigFraction(new BigNum("174"), new BigNum("654")), new BigFraction(new BigNum("256"), new BigNum("32")), new BigFraction(new BigNum("76532"), new BigNum("76654")), new BigFraction(new BigNum("148"), new BigNum("23"))}, "2", "9224235744"},
                    new object[] {new BigNum("3"), new List<BigFraction> {new BigFraction(new BigNum("255"), new BigNum("5")), new BigFraction(new BigNum("250"), new BigNum("355")), new BigFraction(new BigNum("-765"), new BigNum("1871")), new BigFraction(new BigNum("-140"), new BigNum("23"))}, "5", "15276715"},
                };
            }
        }
    }
