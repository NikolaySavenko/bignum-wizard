            ...
            get
            {
                return new[]
                {
                    new object[] {
                        ...
                        new Polynomial(1, new List<BigFraction>() { new BigFraction(new BigNum("3")), new BigFraction(new BigNum("15")) })
                    },
                    new object[] {
                        2,
                        ...
                        new Polynomial(2, new List<BigFraction>() { new BigFraction(new BigNum("20")), new BigFraction(new BigNum("11111")), new BigFraction(new BigNum("9")) }) },
                    new object[] {
                        3,
                        ...
                        new Polynomial(3, new List<BigFraction>() { new BigFraction(new BigNum("234555"), new BigNum("4")), new BigFraction(new BigNum("-15850980")), new BigFraction(new BigNum("-16406505"), new BigNum("214244")), new BigFraction(new BigNum("-13716665295"), new BigNum("10")) })
                    },
                    new object[]
                    {
                        0,
                        ...
                        new Polynomial(0, new List<BigFraction>(){ new BigFraction(new BigNum("-100018240127467456841003024872985079366"), new BigNum("1373136153549541768244")) })
                    },
                    new object[]
                    {
                        5,
                        ...
                        new Polynomial(5, new List<BigFraction>() { new BigFraction(new BigNum("-123456789098765431234567890"), new BigNum("1000000000")), new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero), new BigFraction(new BigNum("123456789098765431234567890")) })
                    },
                    new object[]
                    {
                        1,
                        ...
                        new Polynomial(1, new List<BigFraction>(){ new BigFraction(BigNum.Zero), new BigFraction(BigNum.Zero) }) 
                    },
                    new object[]
                    {
                        4,
                        ...
                        new Polynomial(4, new List<BigFraction>(){ new BigFraction(new BigNum("381219492892820")), new BigFraction(new BigNum("-5")), new BigFraction(BigNum.Zero), new BigFraction(new BigNum("5000000000000000000")), new BigFraction(new BigNum("5")) })
                    },
                    new object[]
                    {
                        0,
                        ...
                        new Polynomial(0, new List<BigFraction>(){ new BigFraction(new BigNum("3333000"), new BigNum("94000")) })
                    },
                    new object[]
                    {
                        1,
                        ...
                        new Polynomial(1, new List<BigFraction>() { new BigFraction(new BigNum("-77777777777777777777777777777770"), BigNum.MinusOne), new BigFraction(new BigNum("-1999999999999999999999990"), new BigNum("666666"))})
                    },
                    new object[]
                    {
                        3,
